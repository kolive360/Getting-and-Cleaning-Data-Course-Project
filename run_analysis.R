...
## 1. Merges the training and the test sets to build one data set
...
#combined$activity <- factor(TidyData$code, labels=c("WALKING", "WALKING_UPSTAIRS", "WALKING_DOWNSTAIRS", "SITTING", "STANDING", "LAYING"))
